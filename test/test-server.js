  ...
  it('responds with home page', function (done) {
    ...
    nock("http://localhost:8082")
      ...
      .reply(200, {
        "status": 200,
        "events": [
          { title: 'an event', id: 1234, description: 'County Event Description', location: 'Berks County', likes: 0 },
          { title: 'another event', id: 5678, description: 'County Event Description', location: 'Berks County', likes: 0 }
        ]
      });
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        chai.assert.isTrue(res.text.includes("<h1>Events App Gary Kong</h1>"));
        return done();
      });
